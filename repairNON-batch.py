...
def init():
    ...
    # 修复集及其状态
    repair_set = dl.get_repair_dataset(train_set, param.per_class_benign_samples_usage, param.per_backdoor_samples_usage, test_tf, sample_fusing=False)
...
if __name__ == '__main__':
    with open("./log-repairNON.txt", 'a') as log_file:
